...
const models=[{id:'classic',name:'CLASSIC',icon:'◒'},{id:'apex',name:'APEX',icon:'◈'},{id:'flow',name:'FLOW',icon:'〽'}];
...
const paths={
  ...
  apex:{
    front:{shoulders:'M185 130 Q260 82 335 130 L322 190 L260 225 L198 190Z',chest:'M198 190 L260 225 L322 190 L305 330 L260 355 L215 330Z',body:'M215 330 L260 355 L305 330 L319 470 L280 474 L260 398 L240 474 L201 470Z',arms:'M185 130 Q150 145 138 210 L120 350 L154 355 L178 225 L198 190Z M335 130 Q370 145 382 210 L400 350 L366 355 L342 225 L322 190Z',sides:'M198 190 L215 330 L201 470 L178 410 L178 225Z M322 190 L305 330 L319 470 L342 410 L342 225Z',legs:'M201 470 L240 474 L225 630 L184 625Z M280 474 L319 470 L336 625 L295 630Z',knees:'M190 482 L239 490 L233 555 L182 570Z M281 490 L328 482 L338 570 L287 555Z',accent:'M215 113 Q235 96 260 108 Q285 96 305 113 L296 142 Q260 157 224 142Z'},
    back:{shoulders:'M485 130 Q560 82 635 130 L622 190 L560 225 L498 190Z',chest:'M498 190 L560 225 L622 190 L605 330 L560 355 L515 330Z',body:'M515 330 L560 355 L605 330 L621 470 L581 474 L560 398 L539 474 L499 470Z',arms:'M485 130 Q450 145 438 210 L420 350 L454 355 L478 225 L498 190Z M635 130 Q670 145 682 210 L700 350 L666 355 L642 225 L622 190Z',sides:'M498 190 L515 330 L499 470 L478 410 L478 225Z M622 190 L605 330 L621 470 L642 410 L642 225Z',legs:'M499 470 L539 474 L525 630 L484 625Z M581 474 L621 470 L636 625 L595 630Z',knees:'M490 482 L539 490 L533 555 L482 570Z M581 490 L628 482 L638 570 L587 555Z',accent:'M515 113 Q535 96 560 108 Q585 96 605 113 L596 142 Q560 157 524 142Z'}
  },
  flow:{
...
function init(){
  document.getElementById('modelGrid').innerHTML=models.map(m=>`<button class="model-card ${state.model===m.id?'active':''}" data-model="${m.id}"><span class="model-thumb">${m.icon}</span><span class="model-name">${m.name}</span></button>`).join('');
